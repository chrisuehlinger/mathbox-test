...
THREE.SpaceControls = function (object, domElement) {
	...
	this.updateMovementVector = function () {
		...
		this.moveVector.x = Math.min(this.maxSpeed, Math.max(-this.maxSpeed, this.moveVector.x + this.movementForce * (-this.moveState.left + this.moveState.right)));
		this.moveVector.y = Math.min(this.maxSpeed, Math.max(-this.maxSpeed, this.moveVector.y + this.movementForce * (-this.moveState.down + this.moveState.up)));
		this.moveVector.z = Math.min(this.maxSpeed, Math.max(-this.maxSpeed, this.moveVector.z + this.movementForce * (-forward + this.moveState.back)));

		this.totalMovementSpeed = Math.sqrt(this.moveVector.x * this.moveVector.x + this.moveVector.y * this.moveVector.y + this.moveVector.z * this.moveVector.z);
		//console.log( 'move:', [ this.moveVector.x, this.moveVector.y, this.moveVector.z ] );
		//console.log(this.totalMovementSpeed);
	};
